 ...
 */
!(function () {
  let c = {}; let z = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (z = document); } catch (c) {} const h = (c.navigator || {}).userAgent; const v = void 0 === h ? '' : h; const l = c; const m = z; const s = (l.document, !!m.documentElement && !!m.head && typeof m.addEventListener === 'function' && m.createElement, ~v.indexOf('MSIE') || v.indexOf('Trident/'), '___FONT_AWESOME___'); const M = (function () { try { return !0; } catch (c) { return !1; } }()); const a = l || {}; a[s] || (a[s] = {}), a[s].styles || (a[s].styles = {}), a[s].hooks || (a[s].hooks = {}), a[s].shims || (a[s].shims = []); const H = a[s]; function V(c, v) {
    const z = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks; const h = void 0 !== z && z; const l = Object.keys(v).reduce((c, z) => { const h = v[z]; return h.icon ? c[h.iconName] = h.icon : c[z] = h, c; }, {}); typeof H.hooks.addPack !== 'function' || h ? H.styles[c] = (function (l) {
      for (let c = 1; c < arguments.length; c++) {
        var m = arguments[c] != null ? arguments[c] : {}; let z = Object.keys(m); typeof Object.getOwnPropertySymbols === 'function' && (z = z.concat(Object.getOwnPropertySymbols(m).filter((c) => Object.getOwnPropertyDescriptor(m, c).enumerable))), z.forEach((c) => {
          let z; let h; let v; z = l, v = m[h = c], h in z ? Object.defineProperty(z, h, {
            value: v, enumerable: !0, configurable: !0, writable: !0,
          }) : z[h] = v;
        });
      } return l;
    }({}, H.styles[c] || {}, l)) : H.hooks.addPack(c, l), c === 'fas' && V('fa', v);
  } const e = {
