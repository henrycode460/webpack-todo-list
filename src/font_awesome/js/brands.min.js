 ...
 */
!(function () {
  let c = {}; let z = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (z = document); } catch (c) {} const l = (c.navigator || {}).userAgent; const h = void 0 === l ? '' : l; const v = c; const m = z; const M = (v.document, !!m.documentElement && !!m.head && typeof m.addEventListener === 'function' && m.createElement, ~h.indexOf('MSIE') || h.indexOf('Trident/'), '___FONT_AWESOME___'); const a = (function () { try { return !0; } catch (c) { return !1; } }()); const s = v || {}; s[M] || (s[M] = {}), s[M].styles || (s[M].styles = {}), s[M].hooks || (s[M].hooks = {}), s[M].shims || (s[M].shims = []); const f = s[M]; function H(c, h) {
    const z = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks; const l = void 0 !== z && z; const v = Object.keys(h).reduce((c, z) => { const l = h[z]; return l.icon ? c[l.iconName] = l.icon : c[z] = l, c; }, {}); typeof f.hooks.addPack !== 'function' || l ? f.styles[c] = (function (v) {
    ...
    }({}, f.styles[c] || {}, v)) : f.hooks.addPack(c, v), c === 'fas' && H('fa', h);
  } const e = {
  ...
  }; !(function (c) { try { c(); } catch (c) { if (!a) throw c; } }(() => { H('fab', e); }));
}());